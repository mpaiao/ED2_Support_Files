...
#------------------------------------------------------------------------------------------#
   ...
   #      Inferno.                                                                         #
   #---------------------------------------------------------------------------------------#
   inferno <<- function(n,alpha=1.0){
      #----- Color entries. ---------------------------------------------------------------#
      nodes     = c( "#10002A", "#280655", "#660C70", "#A12663", "#D6473D", "#F87D00"
                   , "#FCC200", "#FCFF9F")
      #------------------------------------------------------------------------------------#
      ...
      return(ans)
      #------------------------------------------------------------------------------------#
   }#end function inferno
   #----- Inverse colour palette. ---------------------------------------------------------#
   iinferno <- function(n,alpha=1.0){ rev(inferno(n=n,alpha=alpha))}
   #---------------------------------------------------------------------------------------#
   ...
   #----- Inverse colour palette. ---------------------------------------------------------#
   imagma <- function(n,alpha=1.0){ rev(magma(n=n,alpha=alpha))}
   #---------------------------------------------------------------------------------------#
   ...
   #      Viridis.                                                                         #
   #---------------------------------------------------------------------------------------#
   viridis <<- function(n,alpha=1.0){
      #----- Color entries. ---------------------------------------------------------------#
      nodes = c( "#440154", "#482878", "#3E4A89", "#31688E", "#26828E"
      ...
      return(ans)
      #------------------------------------------------------------------------------------#
   }#end function viridis
   #----- Inverse colour palette. ---------------------------------------------------------#
   iviridis <- function(n,alpha=1.0){ rev(viridis(n=n,alpha=alpha))}
   #---------------------------------------------------------------------------------------#
